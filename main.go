...
func main() {
	...
	movies = append(movies, Movie{ID: "4", Isbn: "1003", Title: "MEGHA", Director: &Director{Firstname: "SAMAY", Lastname: "DIYA"}})
	movies = append(movies, Movie{ID: "5", Isbn: "1004", Title: "RISE", Director: &Director{Firstname: "AAYUSHI", Lastname: "GUPTA"}})
